...
static const char * const __error_messages[] = {
	...
	// BSR-988
	[-SS_RESYNC_REPLY_DATA_PENDING_TIMEOUT] = "Failed to set secondary role due to resync reply data pending timeout(10s). Retry to demote first(bsradm secondary r0). if demote timeout continues, disconnect and demote forcibly.",
	// BSR-1393
