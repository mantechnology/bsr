...
fail:
	...
	bsr_err(BSR_LC_TEMP, resource, "failed to create debugfs dentry\n");
}
...
fail:
	...
	bsr_err(BSR_LC_TEMP, connection, "failed to create debugfs dentry\n");
}
...
fail:
	...
	bsr_err(BSR_LC_TEMP, device, "failed to create debugfs entries\n");
}
...
fail:
	...
	bsr_err(BSR_LC_TEMP, peer_device, "failed to create debugfs entries\n");
}
