...
struct adm_cmd {
	...
	unsigned int exclude_parse_show:1; /* BSR-824 BSR-808 cmd excludes parsing of bsrsetup show results */ 
};
...
// DW-1569 incorrect output of config file name from dump/dump-xml.
